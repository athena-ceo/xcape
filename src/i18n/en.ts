...
export const en: Dict = {
  ...
  onboarding: {
    ...
    heritage: {
      q: 'Heritage that may grant a right of return? (optional)',
    ...
    persona: {
      ...
      unavailable: 'Profiles couldn’t be loaded right now. Please try again in a moment.',
    },
  },
  ...
  admin: {
    ...
    colLatestSearch: 'Latest search',
    colCalls: 'AI calls',
    colTokensUser: 'Tokens (in/out)',
    colCost: 'Est. cost',
    colUser: 'User',
    colRequest: 'Request',
    colResult: 'Result',
    ...
    addUser: 'Add user',
    addUserEmail: 'Email',
    addUserPassword: 'Password (min 8)',
    ...
    disableConfirm: 'Disable this account (blocks login, keeps data)?',
    enableConfirm: 'Re-enable this account?',
    removeUser: 'Remove',
    removeUserConfirm: 'Permanently delete this account and ALL its data. Type the email to confirm:',
    removeUserMismatch: 'Email did not match — nothing deleted.',
    removeUserDone: 'Account deleted.',
  ...
  comparison: {
    ...
    addCountryHint: 'Search for any country to add it to your comparison board.',
    ...
    editControls: 'Weight & filter',
    filterNoneMatch: 'No countries match all your active filters.',
    filterFewMatch: 'Only {n} countries match all your active filters.',
    filterRelaxHint: 'Relaxing the “{filter}” filter would add {n} more (e.g. {country}, {score}%).',
    ...
    pinnedBadge: 'Added by you',
    pinnedTitle: 'You added this country — it stays on the board even if it misses a filter.',
    excludedTitle: 'Excluded',
    excludedHint: 'You removed these. They stay out of the comparison until you restore them.',
    restore: 'Restore',
    legend: 'Legend',
    legendGood: 'Good',
    legendWeak: 'Weak',
    legendNogo: 'Avoid',
    tableHint: 'Tip: open a category to set each criterion’s weight and filter; click a country to explore it, a value for its rationale, a score for the breakdown.',
    expandHint: 'open',
  ...
  drilldown: {
    ...
    afford: {
      ...
      verdict: {
        comfortable: 'Comfortable — your budget covers local costs with room to spare.',
        manageable: 'Manageable — your budget covers local costs.',
        tight: 'Tight — your budget barely covers local costs.',
        insufficient: 'Insufficient — local costs exceed your budget.',
      },
      incomeTitle: 'Visa income eligibility',
      incomeHint: 'Income-based residence routes compared against your annualised budget ({income}/yr).',
  ...
  explore: {
    ...
    onBoard: 'On board',
    replaceConfirm: 'The board is full (5 countries). Replace the lowest-ranked, {weakest} ({score}%), with {new}?',
    sparksTitle: 'Sparks',
  ...
  visaFinder: {
    title: 'Golden-visa finder',
    subtitle: 'Tell us what you can put in — a lump sum to invest or steady income — and we’ll rank the countries that opens a residency route to.',
    goalLabel: 'Qualify with',
    goalInvest: 'A lump-sum investment',
    goalIncome: 'Passive / pension income',
    amountInvest: 'Amount to invest',
    amountIncome: 'Annual income',
    amountHint: 'In {currency} (your budgeting currency).',
    search: 'Find countries',
    searching: 'Searching…',
    resultsCount: '{n} countries within reach',
    none: 'No matching programs for that amount yet. Try a higher amount — or the data may still be filling in for some countries.',
    from: 'From',
    difficulty: 'Accessibility',
    viewCountry: 'View country →',
    disclaimer: 'Program rules change and eligibility depends on your circumstances — verify with official sources before acting.',
  },
  reasons: {
    details: 'See details',
  ...
  adminPlaces: {
    ...
    saved: 'Saved.',
    regen: 'Regenerate',
    regenHint: 'Regenerate this country’s AI data — opens the country and re-runs every criterion, visa pathway and the budget breakdown',
    regenConfirm: 'Regenerate all AI data for {name}? This opens the country page and re-runs the AI for every criterion, visa pathway and the budget — overwriting the cached values. It can take a few minutes.',
  },
  waiting: {
    messages: [
